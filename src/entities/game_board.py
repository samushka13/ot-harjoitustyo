    ...
    def _build(self):
        ...
        while segment_counter < self.segments:
            if segment_counter == 0:
                get_board_segment(self.canvas, distance, self.segment, self.special_color)
            if segment_counter in all_category_segments[0]:
                get_board_segment(self.canvas, distance, self.segment, self.category_colors[0])
            if len(self.categories) >= 2:
                if segment_counter in all_category_segments[1]:
                    get_board_segment(self.canvas, distance, self.segment, self.category_colors[1])
            if len(self.categories) >= 3:
                if segment_counter in all_category_segments[2]:
                    get_board_segment(self.canvas, distance, self.segment, self.category_colors[2])
            if len(self.categories) >= 4:
                if segment_counter in all_category_segments[3]:
                    get_board_segment(self.canvas, distance, self.segment, self.category_colors[3])
            if len(self.categories) >= 5:
                if segment_counter in all_category_segments[4]:
                    get_board_segment(self.canvas, distance, self.segment, self.category_colors[4])
            if len(self.categories) >= 6:
                if segment_counter in all_category_segments[5]:
                    get_board_segment(self.canvas, distance, self.segment, self.category_colors[5])
            if len(self.categories) >= 7:
                if segment_counter in all_category_segments[6]:
                    get_board_segment(self.canvas, distance, self.segment, self.category_colors[6])
            if len(self.categories) >= 8:
                if segment_counter in all_category_segments[7]:
                    get_board_segment(self.canvas, distance, self.segment, self.category_colors[7])
            if len(self.categories) >= 9:
                if segment_counter in all_category_segments[8]:
                    get_board_segment(self.canvas, distance, self.segment, self.category_colors[8])
            if len(self.categories) >= 10:
                if segment_counter in all_category_segments[9]:
                    get_board_segment(self.canvas, distance, self.segment, self.category_colors[9])
            if len(self.categories) >= 11:
                if segment_counter in all_category_segments[10]:
                    get_board_segment(self.canvas, distance, self.segment, self.category_colors[10])
